...
//         const teams = [{teamName: "Team1", mentorId: "621d35383e5c3315845ca334", status: true }, {teamName: "Team2", mentorId: "4edd40c86762e0fb12000003", status: true }];
//         await teamModel.collection.insertMany(teams);
//         const res = await request(server).get("/team/getAll");
